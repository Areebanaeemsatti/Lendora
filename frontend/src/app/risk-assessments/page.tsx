        ...
        {currentApp ? (
          ...
          <div className="space-y-6">
            ...
            <Card className="p-4 border-emerald-500/20 bg-emerald-500/5">
              <p className="text-xs font-semibold uppercase tracking-wider text-emerald-400">Selected queue record</p>
              ...
              <p className="text-xs text-zinc-500 mt-3">
                Full scorecards appear for applications submitted through the borrower form. This seed record lives in the local queue only.
              </p>
            </Card>
          </div>
        ) : (
          <Card className="p-12 text-center">
            <div className="max-w-md mx-auto space-y-4">
              ...
              <h3 className="text-base font-bold text-zinc-100">No Borrower Application Selected</h3>
...
export default function RiskAssessmentsPage() {
  return (
    <ProtectedRoute>
      <Suspense fallback={<div className="p-8 text-center text-xs text-zinc-500">Loading underwriter dashboard...</div>}>
