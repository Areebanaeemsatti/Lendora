...
export function AlternativeSignalsSection({ formData, errors, onChange }: Props) {
  return (
    <Card id="section-3" className="border-teal-200/70 bg-gradient-to-br from-white to-teal-50/20">
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <span className="hidden sm:inline-flex text-[11px] font-semibold bg-teal-100/80 text-teal-800 px-2.5 py-0.5 rounded-full border border-teal-200">
