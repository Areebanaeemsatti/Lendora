      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80">
            ...
            <span className="text-[10px] text-slate-400 mt-0.5 block">Estimated / Stated</span>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80">
            ...
            <span className="text-[10px] text-slate-400 mt-0.5 block">Living & Rent</span>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80">
            ...
            <span className="text-[10px] text-slate-400 mt-0.5 block">Monthly obligations</span>
          </div>
        </div>

        {/* Cashflow Surplus / Net Balance Bar */}
        <div className="p-4 rounded-xl bg-gradient-to-r from-slate-900 to-slate-850 text-white flex items-center justify-between">
