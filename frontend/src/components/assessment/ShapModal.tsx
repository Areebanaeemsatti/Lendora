...
export function BorrowerOverviewCard({ application }: Props) {
  ...
  return (
    <div className="bg-zinc-950 text-white rounded-lg p-6 border border-zinc-800 shadow-md">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-zinc-800/80">
        <div className="flex items-start sm:items-center gap-4">
          <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-700 text-white border border-emerald-400/30 flex items-center justify-center font-bold text-2xl shadow-lg shadow-emerald-950/50 shrink-0">
