  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <MiniStat label="Queue" value={String(stats.total)} hint="Local mock applications" />
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-white">Underwriter Decision Queue</CardTitle>
              </div>
                ...
                {visible.length === 0 && (
                  <tr>
                    <td colSpan={8} className="px-5 py-10 text-center text-sm text-slate-500">
                      <Filter className="w-4 h-4 inline-block mr-2 text-slate-400" />
                  ...
                  return (
                    ...
                    >
                      <td className="px-5 py-4">
                        ...
                        <div className="text-[11px] font-mono text-slate-400 mt-0.5">{app.id}</div>
                      </td>
                      <td className="px-5 py-4 font-mono text-slate-800">{formatPKR(app.income)}</td>
                      <td className="px-5 py-4 font-mono font-semibold text-slate-900">
                        {formatPKR(app.requestedAmount)}
                      </td>
                      <td className="px-5 py-4">
                        <span className="font-mono font-bold text-emerald-700">{app.altCreditScore}</span>
                      </td>
                      <td className="px-5 py-4">
